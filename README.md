...
| os | Prepares the operating system for the installation of OPDK. This covers operating system packages and updates to system configuration files. |
...
| common | Install common Apigee components used on all nodes, does not include operating system packages |
