...
| os | Prepares the operating system for the installation of OPDK as covered [here]((https://docs.apigee.com/private-cloud/v4.18.01/installation-overview)) and [here](https://docs.apigee.com/private-cloud/v4.18.01/install-edge-apigee-setup-utility). This covers operating system packages and updates to system configuration files. |
